        ...
        <el-table-column label="品牌LOGO" align="center">
          <template #="{ row }">
            <img
              :src="row.logoUrl"
              style="width: 100px"
              onerror="this.src='http://39.98.123.211/group1/M00/03/D9/rBHu8mHmKC6AQ-j2AAAb72A3EO0942.jpg'"
            />
          </template>
        </el-table-column>
...
const rules = {
  ...
  logoUrl: [{ required: true, message: '请上传品牌标识', trigger: 'blur' }],
}
// 气泡确认框确认按钮的回调
